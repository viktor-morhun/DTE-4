            ...
            {currentSlide === 1 && (
              <div className="flex-1 flex flex-col">
                <div className="mb-[30px] min-h-[44px]">
                  <h2 className="text-[20px] leading-[24px] font-medium text-white">True or False: Confidence can grow through small, repeated actions.</h2>
                </div>
              ...
              <div className="flex-1 flex flex-col relative">
                <div className="mb-[30px] min-h-[44px]">
                  <h2 className="text-[20px] leading-[24px] font-medium text-white">
                    Why does protecting the habits that built your confidence keep your drive steady?
                  </h2>
                </div>
